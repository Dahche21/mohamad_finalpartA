...
double weight1=0.7;//weights of or gate
double weight2=0.3;
double bias=-0.2;
...
int out;
  ...
  while (1)
  {
	  ...
	  htim3.Instance->CCR1= weight1 * (htim3.Instance->ARR );
	  htim5.Instance->CCR3= weight2 * (htim5.Instance->ARR );

	  pwm1=htim3.Instance->CNT >= htim3.Instance->CCR1? 0 : 1;
